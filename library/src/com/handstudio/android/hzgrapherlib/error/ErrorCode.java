...
public class ErrorCode {
	...
	public static final ErrorCode INVALIDATE_GRAPH_AND_LEGEND_SIZE 	= new ErrorCode(0x00000002		,"INVALIDATE_GRAPH_AND_LEGEND_SIZE");
	public static final ErrorCode NOT_MATCH_GRAPH_SIZE 				= new ErrorCode(0x00000003		,"NOT_MATCH_GRAPH_SIZE");
